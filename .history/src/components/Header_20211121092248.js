                ...
                <div className="col-md-12">
                    <nav className="navbar  navbar-dark bg-dark">
                            <ul className="nav">
                                ...
                                <li className="nav-item"><Link to="/carts" className="nav-link link-item"><i class="fas fa-shopping-cart"></i> Giỏ Hàng : {this.props.numberCart} | <i class="fas fa-hand-holding-usd"></i> {Number(TotalCart).toLocaleString('en-US')}$</Link></li>
                            </ul>
                    </nav>
                </div>
            </div>
